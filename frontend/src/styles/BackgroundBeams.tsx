        ...
        <defs>
          {pathData.map((_, i) => (
            <linearGradient
              ...
              y2="100%"
            >
              <stop offset="0%" stopColor="#FFFDD0" stopOpacity="0" />
              <stop offset="20%" stopColor="#FFFDD0" stopOpacity="1" />
              <stop offset="50%" stopColor="#B22222" stopOpacity="1" />
              <stop offset="80%" stopColor="#660000" stopOpacity="1" />
